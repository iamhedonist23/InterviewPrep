    ...
    <section className="py-16 sm:py-20">
      <Container>
        ...
        <p className="mt-4 max-w-2xl text-lg leading-8 text-ink/60">
          Choose a role or topic to find practical questions and answer guidance
                ...
                {categories
                  ...
                  .map((category) => (
                    <Link
                      ...
                      className="group rounded-2xl border border-ink/10 bg-white/70 p-5 hover:-translate-y-1 hover:border-coral"
                      key={category.id}
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <ArrowRight
                          size={18}
                          className="text-ink/35 group-hover:text-coral"
                        />
                      </div>
                      <p className="mt-3 text-sm text-ink/55">
                        {category._count.questions} interview questions
                      </p>
                    </Link>
                  ))}
              </div>
