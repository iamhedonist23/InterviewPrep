...
export const metadata: Metadata = { title: "Practice Interview Questions", description: "Practice interview questions for free, choose a category and difficulty, and build confidence one question at a time.", alternates: { canonical: "/practice" } };
