...
/**
 * DB-ready Java topic seed: 329/356
 *
...
export const topic: TopicSeed = {
  ...
  sections: [
    ...
    {
      title: "Practice",
      content: "Build a small program demonstrating `HashMap vs ConcurrentHashMap` with the operation it is designed for. Include one boundary case such as a duplicate, missing key, ordering change, or mutation. Explain the observed result from the collection's contract."
    }
  ],
};
