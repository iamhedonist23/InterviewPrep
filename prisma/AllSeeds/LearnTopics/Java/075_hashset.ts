...
/**
 * DB-ready Java topic seed: 75/356
 *
...
export const topic: TopicSeed = {
  ...
  sections: [
    ...
    {
      title: "Practice",
      content: "Build a small program demonstrating `HashSet` with the operation it is designed for. Include one boundary case such as a duplicate, missing key, ordering change, or mutation. Explain the observed result from the collection's contract."
    }
  ],
};
