...
async function seed() {
  ...
  const topic: TopicSeed = {
    ...
    description: "Detailed, human-oriented explanation of Java interview fundamentals. Covers the Java rule or API contract, concrete code, runtime behavior, edge cases, common misconceptions, production considerations, and interview preparation.",
    estimatedMinutes: 20,
    sections: [{"title": "What it is and why it matters", "content": "Java is an interview topic because candidates are expected to explain the Java contract, not just recall a definition. The strongest answer distinguishes the language/API guarantee from implementation details and demonstrates the rule with a small example."}, {"title": "A concrete Java example", "content": "// Be ready to explain Java with a minimal Java example.\nSystem.out.println(\"Explain the rule, then demonstrate it\");"}, {"title": "How the mechanism behaves", "content": "For Java, organize the answer around the governing Java rule, the observable behavior, and the boundary case that changes the result. If the question is about an implementation, explicitly label HotSpot/JDK behavior as implementation detail."}, {"title": "Edge cases and common mistakes", "content": "The common interview mistake is answering Java with a slogan. A strong candidate gives the condition under which the statement is true and then gives a counterexample or edge case."}, {"title": "Using it in production", "content": "In production discussions of Java, connect the concept to correctness, maintainability, performance, and operational risk rather than treating the interview definition as the whole story."}, {"title": "Interview-ready explanation", "content": "A strong interview answer for Java interview fundamentals should start with the precise definition, identify the Java rule or API contract, explain the example, and then mention one edge case and one trade-off. If asked a follow-up, explain the condition under which the original statement changes."}, {"title": "Practice questions", "content": "1. Define Java.\n2. What does Java guarantee?\n3. Show a code example.\n4. Give an edge case.\n5. What is a common misconception?\n6. What changes in production?"}],
  };
