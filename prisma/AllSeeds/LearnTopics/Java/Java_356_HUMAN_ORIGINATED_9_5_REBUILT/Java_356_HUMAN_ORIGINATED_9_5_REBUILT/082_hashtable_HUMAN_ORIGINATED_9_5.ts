...
async function seed() {
  ...
  const topic: TopicSeed = {
    title: "Hashtable",
    slug: "hashtable",
    description: "Detailed, human-oriented explanation of Hashtable. Covers the Java rule or API contract, concrete code, runtime behavior, edge cases, common misconceptions, production considerations, and interview preparation.",
    estimatedMinutes: 20,
    sections: [{"title": "What it is and why it matters", "content": "Hashtable is a concrete Java collection or collection family with specific ordering, equality, complexity, null-handling, and concurrency characteristics. The correct choice depends on the access pattern rather than on a generic claim that one collection is faster."}, {"title": "A concrete Java example", "content": "// Example usage of Hashtable\n// Choose the operation that matches the collection contract.\nSystem.out.println(\"Use Hashtable according to its ordering and access semantics\");"}, {"title": "How the mechanism behaves", "content": "For Hashtable, learn what data structure backs the implementation, what ordering is guaranteed, how equality is determined, which operations are expected to be fast, and what happens under resizing or contention. Separate API guarantees from current JDK implementation details."}, {"title": "Edge cases and common mistakes", "content": "A common mistake with Hashtable is quoting a complexity or ordering property without its conditions. Check null support, iterator behavior, mutation of elements/keys, and whether ordering is guaranteed or merely observed."}, {"title": "Using it in production", "content": "Choose Hashtable from measured workload characteristics: read/write ratio, ordering, memory footprint, concurrency, and key/value semantics. Do not choose by reputation alone."}, {"title": "Interview-ready explanation", "content": "A strong interview answer for Hashtable should start with the precise definition, identify the Java rule or API contract, explain the example, and then mention one edge case and one trade-off. If asked a follow-up, explain the condition under which the original statement changes."}, {"title": "Practice questions", "content": "1. What contract does Hashtable provide?\n2. What is the usual backing structure?\n3. Which operations are efficient?\n4. What edge case matters?\n5. What alternative would you choose and why?"}],
  };
